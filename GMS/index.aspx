...
<div class="login-box">
  <div class="login-logo">
    <%--<img src="kopinit-opt1.png" style="width:304px;height:228px;">--%>
  ...
  <div class="login-box-body">
    ...
    <form action="../../index2.html" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="number" id="txtPassword" class="form-control" placeholder="Mobile No.">
...
<script>
    ...
    <script src="jscripts/jsIndex.js" type="text/javascript"></script>
</body>
