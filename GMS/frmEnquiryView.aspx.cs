...
namespace GMS
{
    public partial class frmEnquiryView : System.Web.UI.Page
    {
        ...
        public static string fnEnquiryView()
        {
            string strXml = "";
            try
            {
                ...
                SqlCommand objCmd = new SqlCommand("wb_enquiry_view", objCon);
        ...
        [System.Web.Services.WebMethod]
        public static string fnEnquiryDelete(string intId)
        {
            int intReturn = 0;
            ...
            {
                SqlConnection objCon = new SqlConnection(strConn);
                SqlCommand objCmd = new SqlCommand("wb_enquiry_delete", objCon);
                objCmd.CommandType = CommandType.StoredProcedure;

                objCmd.Parameters.Add("@user_id", SqlDbType.BigInt).Value = Convert.ToInt64(HttpContext.Current.Session["user_id"]);

                objCmd.Parameters.Add("@enqu_id", SqlDbType.BigInt).Value = Convert.ToInt64(intId);
